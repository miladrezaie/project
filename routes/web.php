...
Route::get('admin/form','FormController@show')->name('form.show');

//Route::get('search','FormController@searchFunction')->name('form.show.search');

Route::delete('admin/form/{id}','FormController@delete')->name('form.delete');

Route::post('admin/form', 'FormController@store')->name('form.store');
